    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "14px", alignItems: "center" }}>
          ...
          <a href="/trade" className="home-nav-link" style={{ color: "rgba(176,142,80,0.3)", fontSize: "0.38rem", letterSpacing: "0.15em", textDecoration: "none", transition: "color 0.2s" }}>TRADE CO.</a>
          <span style={{ color: "rgba(176,142,80,0.12)", fontSize: "0.38rem" }}>·</span>
