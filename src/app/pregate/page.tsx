        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <p style={{
              ...
              Watch for the email — it comes before the gate opens.
            </p>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: GOLD, fontSize: "10px", letterSpacing: "0.3em", marginBottom: 12, opacity: 0.7 }}>
              YOUR FREE SEAT · 7GNET
            </p>
            <h3 style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontStyle: "italic",
            ...
            <p style={{
              ...
              Private channels by territory. Brother-to-brother intelligence.
              Built this May. Releasing this June. Founding-only access —
              your seat is locked in now.
            </p>
            <div style={{ display: "grid", gap: 8 }}>
              {[
                "Territory channel — only brothers in your region",
                "Direct line to Steward and oracle team",
                "Early access to trade routes and revenue systems",
                "No public signups ever — founding access only",
              ].map(item => (
                <div key={item} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                  <span style={{ color: GOLD, fontSize: "14px", flexShrink: 0, marginTop: 1 }}>◈</span>
                  <p style={{ color: "rgba(232,224,208,0.6)", fontSize: "13px", lineHeight: 1.5 }}>{item}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: FLAME, fontSize: "10px", letterSpacing: "0.3em", marginBottom: 12, opacity: 0.85 }}>
              ALSO OPEN · IN PERSON · HAWAII
            </p>
            <h3 style={{
              fontFamily: "'Cormorant Garamond', serif",
              fontStyle: "italic",
              ...
              MAYDAY 48 · Founding Aliʻi Seats
            </h3>
            <p style={{
              fontSize: "14px",
              ...
              48-hour brotherhood formation across 4 weekends in May 2026
              on West Oʻahu. 12 founding Aliʻi seats. 1% equity. Forever.
              Bring a team of 3–5.
            </p>
            <div style={{ display: "grid", gap: 8 }}>
              {[
                ["🌕", "MAY 1–3", "Flower Moon · Opening · 1 seat remaining"],
                ["·",  "MAY 8–10", "Weekend 2"],
                ["·",  "MAY 15–17", "Weekend 3"],
                ["🌕", "MAY 29–31", "Blue Moon · Sealing · Gate closes forever"],
              ].map(([moon, dates, label]) => (
                <div key={dates} style={{ display: "flex", gap: 12, alignItems: "center" }}>
                  <span style={{ color: GOLD, fontSize: "12px", width: 18, flexShrink: 0 }}>{moon}</span>
                  <span style={{ color: GOLD, fontSize: "13px", width: 90, flexShrink: 0 }}>{dates}</span>
                  <span style={{ color: "rgba(232,224,208,0.4)", fontSize: "13px" }}>{label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <p style={{
            ...
            Mākoa Order · Worldwide · Est. 2026<br />
