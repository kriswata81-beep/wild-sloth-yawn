      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "24px 16px 40px" }}>
        ...
        <Section title="Your Service Route" accent={BLUE}>
          ...
          <p style={{ color: "rgba(232,224,208,0.25)", fontSize: "0.45rem", lineHeight: 1.7 }}>
            ...
            Service route income: 80% to you · 10% Mana council · 10% Hale fund. Aliʻi Plan jobs pay $797/mo crew share. Kamaʻāina jobs pay $397/mo crew share. XI assigns based on region and category.
          </p>
        </Section>
