...
export const PRODUCTS: Record<ProductId, Product> = {
  DUES_DOWN: {
    ...
    description: "25% down payment on $997 annual Mākoa Order membership dues",
    amount: 24925,
    displayPrice: "$249.25",
  },
  MAYDAY_WAR_VAN_EARLY: {
    id: "MAYDAY_WAR_VAN_EARLY",
    name: "MAYDAY War Van VIP — Early Bird (25% Down)",
    description: "25% down on $799 War Van VIP early bird seat · MAYDAY Founding 48",
    amount: 19975,
    displayPrice: "$199.75",
  },
  MAYDAY_WAR_VAN_LAST: {
    id: "MAYDAY_WAR_VAN_LAST",
    name: "MAYDAY War Van VIP — Last Call (25% Down)",
    description: "25% down on $999 War Van VIP last call seat · MAYDAY Founding 48",
    amount: 24975,
    displayPrice: "$249.75",
  },
  MAYDAY_WAR_ROOM_EARLY: {
    id: "MAYDAY_WAR_ROOM_EARLY",
    name: "MAYDAY War Room — Early Bird (25% Down)",
    description: "25% down on $499 War Room early bird seat · MAYDAY Founding 48",
    amount: 12475,
    displayPrice: "$124.75",
  },
  MAYDAY_WAR_ROOM_LAST: {
    id: "MAYDAY_WAR_ROOM_LAST",
    name: "MAYDAY War Room — Last Call (25% Down)",
    description: "25% down on $699 War Room last call seat · MAYDAY Founding 48",
    amount: 17475,
    displayPrice: "$174.75",
  },
  MAYDAY_MASTERMIND_EARLY: {
    id: "MAYDAY_MASTERMIND_EARLY",
    name: "MAYDAY Mastermind — Early Bird",
    description: "Full price early bird Mastermind seat · MAYDAY Founding 48",
    amount: 29900,
    displayPrice: "$299",
  },
  MAYDAY_MASTERMIND_LAST: {
    id: "MAYDAY_MASTERMIND_LAST",
    name: "MAYDAY Mastermind — Last Call",
    description: "Full price last call Mastermind seat · MAYDAY Founding 48",
    amount: 39900,
    displayPrice: "$399",
  },
  MAYDAY_DAY_PASS_EARLY: {
    id: "MAYDAY_DAY_PASS_EARLY",
    name: "MAYDAY Day Pass — Early Bird",
    description: "Full price early bird Day Pass · MAYDAY Founding 48",
    amount: 14900,
    displayPrice: "$149",
  },
  MAYDAY_DAY_PASS_LAST: {
    id: "MAYDAY_DAY_PASS_LAST",
    name: "MAYDAY Day Pass — Last Call",
    description: "Full price last call Day Pass · MAYDAY Founding 48",
    amount: 19900,
    displayPrice: "$199",
  },
  TEAM_WAR_VAN_3: {
